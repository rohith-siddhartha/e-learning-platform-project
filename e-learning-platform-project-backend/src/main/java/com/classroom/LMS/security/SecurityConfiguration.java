...
//    }
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(this.userCustomDetailsService).passwordEncoder(passwordEncoder());
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .disable()
                .authorizeRequests()
                .antMatchers("/generate", "/student/create", "/instructor/create", "/test").permitAll()
